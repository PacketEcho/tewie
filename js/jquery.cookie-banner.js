...
(function($, window, document, undefined) {
	...
	$.cookieBanner = function(settings) {
		...
		var defaults = {
			...
			bannerText: {
				en: 'This website uses cookies (also third-party cookies) to provide you a better navigation experience. By closing this banner, or clicking any of its elements, you agree to the use of cookies.'
			},
			blockCookie: true,
		...
		if (readCookie(defaults.cookieName) === null && !isPrivacyPage()) {
			...
			$(defaults.prependBannerTo).prepend(
				'<div class="container fixed-bottom"><div id="cookie-consent" class="alert alert-dark alert-dismissible fade show" role="alert">' +
